...
var swear_words_arr = ["시발", "씨발", "씨빨", "씨바", "씨팔", "씨이발", "씨입발", "씨입팔", "씨이빨",
    ...
    "죽어", "뒤져", "디져라", "뒈지라", "디졌네", "뒤진놈", "후장", "항문", "항문쑤셔","ㅅㅂ","tq","병시나","바보","멍청이"];
...
function generateBotResponse(userMessage) {
    ...
    const responses = {
        ...
        "심심해": "심심하면 노래 추천해줄까?",
        "졸려": "나도 지금 개졸림 ㅠㅠㅠ",
        "행복해": "행복하다니 좋은 인생을 살고 있구나",
        "배고파": "배고프면 나한테 음식 추천 한번 받아볼래?",
        "피곤해": "지금 진짜 도희도 피곤할듯 ㅇㅇ",
        "우울해": "우울할 땐 레몬사탕이지 ㅋ",
        "기분 좋아": "기분 쏘 굿~~~?",
        "뭐해": "나 언제든지 대화할 준비가 되어있는 봇",
        "어디 살아?": "알아서 뭐 하게",
        "무서워": "너 뒤에...",
        "아프다": "병원 갔다 왔어?",
        "잘자": "그래그래 잘 자",
        ...
        "고민 있어": "무슨 고민인디?",
        "좋아해": "나는 이미 임자가 있어",
        "재밌어": "재미있게 놀아 줬으니까  3333-03-3368530 카카오뱅크 박도희 입금해 줄래?",
        "지루해": "그럼 가서 게임해",
        "대화" : "ㄱㄱ",
        "취미" : "나 게임 좋아하는데 너 뭐 좋아함?",
        "게임" : "게임은 아무래도 로스트아크가 최고지",
